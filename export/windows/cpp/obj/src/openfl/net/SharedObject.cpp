...
{
		HX_STACK_FRAME("openfl.net.SharedObject","setProperty",0xd13889dc,"openfl.net.SharedObject.setProperty","openfl/net/SharedObject.hx",226,0x31b7bda9)
		HX_STACK_THIS(this)
...
int SharedObject_obj::get_size( ){
	HX_STACK_FRAME("openfl.net.SharedObject","get_size",0x91348765,"openfl.net.SharedObject.get_size","openfl/net/SharedObject.hx",244,0x31b7bda9)
	HX_STACK_THIS(this)
	HX_STACK_LINE(244)
	return (int)0;
}
