...
::grid::GridMap_obj::__register();
::grid::GridData_obj::__register();
::grid::BaseGrid_obj::__register();
...
::grid::BaseGrid_obj::__boot();
::grid::GridData_obj::__boot();
::grid::GridMap_obj::__boot();
