...
class BuildingFactory
{
	...
	'{"buildings":[{"requiresPower": false, "area":"N4", "techLevel":0, "productionType":"power", "productionRate":1, "name":"Power Plant","lockTile":true},{"requiresPower": true, "area":"N4", "techLevel":0, "productionType":"power", "productionRate":1, "name":"Power Line","lockTile":false}]}';
	public function new() 
	{
